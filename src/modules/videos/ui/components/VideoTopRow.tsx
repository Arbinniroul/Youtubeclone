...
import { VideoReaction } from "./VideoReactions";
        ...
        <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-3 w-[70%]">
                    <Skeleton className="w-10 h-10  rounded-full shrink-4"/>
...
<div className="flex flex-col gap-4 mt-4 ">
    ...
    <div className="flex overflow-x-auto sm:min-w-[calc(50%-6px)] sm:justify-end sm:overflow-visible pb-2 mb-2 sm:pb-0 sm:mb-0 gap-2">
      <VideoReaction videoId={video.id} likes={video.likeCount} dislikes={video.dislikeCount} viewerReaction={video.viewerReactions}/>
